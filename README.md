...
```javascript
BigInt = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/bigint-ctor@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/bigint-ctor@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-bigint-support@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/bigint-ctor@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
