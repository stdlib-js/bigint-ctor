...
tape( 'the main export is an alias for `BigInt`', opts, function test( t ) {
	t.strictEqual( BigInteger, BigInt, 'is an alias' ); // eslint-disable-line n/no-unsupported-features/es-builtins
	t.end();
});
...
tape( 'to generate a BigInt object, must wrap in `Object` call', opts, function test( t ) {
	...
	t.strictEqual( isBigInt.isObject( v ), true, 'returns expected value' );
	t.end();
});
